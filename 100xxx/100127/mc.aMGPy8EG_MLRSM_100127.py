...
# -*- coding: utf-8 -*-
"""
Job option for MLRSM p p -> mu mu j j (MW2 = 4.0TeV,  MN4 = 4.0TeV, MN5 = 4.0TeV, MN6 = 4.0TeV) 
...
MLRSMCommon.parameters_paramcard['mass']['MN4'] = 4000.0
MLRSMCommon.parameters_paramcard['mass']['MN5'] = 4000.0
MLRSMCommon.parameters_paramcard['mass']['MN6'] = 4000.0
