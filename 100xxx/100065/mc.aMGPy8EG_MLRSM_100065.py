...
# -*- coding: utf-8 -*-
"""
Job option for MLRSM p p -> mu mu j j (MW2 = 5.199999999999998TeV,  MN4 = 1.6TeV, MN5 = 1.6TeV, MN6 = 1.6TeV) 
...
MLRSMCommon.parameters_paramcard['mass']['MN4'] = 1600.0
MLRSMCommon.parameters_paramcard['mass']['MN5'] = 1600.0
MLRSMCommon.parameters_paramcard['mass']['MN6'] = 1600.0
