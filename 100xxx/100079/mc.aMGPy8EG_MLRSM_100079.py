...
# -*- coding: utf-8 -*-
"""
Job option for MLRSM p p -> mu mu j j (MW2 = 5.799999999999998TeV,  MN4 = 2.5TeV, MN5 = 2.5TeV, MN6 = 2.5TeV) 
...
MLRSMCommon.parameters_paramcard['mass']['MN4'] = 2500.0
MLRSMCommon.parameters_paramcard['mass']['MN5'] = 2500.0
MLRSMCommon.parameters_paramcard['mass']['MN6'] = 2500.0
